...
def get_split_indices(all_meta, train_split, val_split, merge_scheme):
    ...
    landsat = pd.read_csv(os.path.join(direct, 'Landsat final versions', 'Without ANY duplicates and errors','detailed', 'test.csv'), names=CAMEROON_META_COLNAMES)
...
split_data('all.csv', "detailed-temp3")
