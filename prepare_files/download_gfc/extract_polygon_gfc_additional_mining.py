...
def polygon_from_shapes_x4():
    ...
    for year in ['2015', '2016', '2017', '2019']:
        r1= shapefile.Reader(os.path.join(os.getcwd(), 'input', 'Shapes', 'mining_' + year + '.shp'))
        ...
        #STEP 3: Extract one polygon from GFC
            ...
            #STEP 4: Build pkl file from polygon 
                path_shapes=os.path.join(os.getcwd(), 'output', str(year), 'mining_' + year + '.shp_additional4')
