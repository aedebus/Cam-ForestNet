...
def polygon_from_intersection(shapes, year):
    """
    Parameters
    ----------
    shapes : shp
    ...
    """
    r1= shapefile.Reader(os.path.join(os.getcwd(), 'input', 'WorldCover', shapes, 'worldcover_intersection.shp'))
    ...
    for index in range (0, maximum): #to extract all shapes
        ...
        path_shapes=os.path.join(os.getcwd(), 'output', str(year), 'WorldCover.shp')
