...
def download_gain_and_cover_from_images(sensor):
    """
        ...
        for d in list_dir:
            ...
            for dn in list_dir_sh:
                ...
                if os.path.exists(os.path.join(path_sh, str(index), sensor)):
                    ...
                    # treecover = dataset.select('treecover2000') #Tree canopy cover for year 2000 #Not used in ForestNet
...
def download_gain_and_cover_from_shape(sensor, shape):
    """
...
def download_gain_and_cover_from_year(sensor, shape, year):
    """
...
def download_gain_and_cover_from_index(sensor, shape, year):
    """
...
if __name__ == "__main__":
    fire.Fire(download_gain_and_cover_from_images)
    #fire.Fire(download_gain_and_cover_from_shape)
    #fire.Fire(download_gain_and_cover_from_year)
    #fire.Fire(download_gain_and_cover_from_index)
